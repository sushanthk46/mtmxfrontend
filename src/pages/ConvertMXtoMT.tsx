...
export default function ConvertMXtoMT() {
  ...
  const mxTypes = configManager.getMXTypes();
  ...
  const handleDownload = () => {
    if (result?.downloadUrl) {
      ...
      a.download = `converted_${conversionType}_${Date.now()}.${activeTab === "folder" ? "zip" : "mt"}`;
      ...
      const a = document.createElement("a");
      a.href = url;
      a.download = `converted_${conversionType}_${Date.now()}.mt`;
      document.body.appendChild(a);
      a.click();
      document.body.removeChild(a);
          ...
          <Card className="glass-effect">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Select MX message type">
                      {conversionType
                        ? mxTypes.find((type) => type.value === conversionType)
                            ?.label
                        : "Select MX message type"}
                    </SelectValue>
                  </SelectTrigger>
                  <SelectContent>
                    {mxTypes.map((type) => (
              ...
              {conversionType && (
                <div className="p-3 bg-primary/5 rounded-lg border border-primary/20">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {
                      mxTypes.find((t) => t.value === conversionType)
                        ?.description
                    }
                  </p>
                </div>
        ...
        <div className="lg:col-span-2">
          <Card className="glass-effect">
            <CardHeader>
              ...
              <CardDescription>
                Choose how you want to provide the MX message for conversion
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mb-4">
                        Select a single MX message file for conversion
                      </p>
                      <FileUpload
                ...
                <TabsContent value="folder" className="mt-6">
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mb-4">
                        Select multiple MX message files for batch conversion
                      </p>
                      <FileUpload
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground mb-2">
                          Paste your MX message content below
                        </p>
                        <Textarea
                          id="input-content"
                          placeholder="Paste your MX message here..."
                          value={inputContent}
                      ...
                      <div>
                        <Label className="text-base font-medium">
                          Converted MT Content
                        </Label>
                        <p className="text-sm text-muted-foreground mb-2">
                          The converted MT format will appear here
                        </p>
                        <Textarea
                          value={outputContent}
                          readOnly
                          placeholder="Converted MT content will appear here..."
